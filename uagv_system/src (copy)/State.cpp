...
NavigationState::NavigationState(Machine * machine){}
...
RemoteState::RemoteState(Machine * machine){}
...
RegistrationState::RegistrationState(Machine * machine){}
...
LiftUpState::LiftUpState(Machine * machine){}
...
LiftDownState::LiftDownState(Machine * machine){}
LiftDownState::~LiftDownState(){} 
...
ChargingState::ChargingState(Machine * machine){}
